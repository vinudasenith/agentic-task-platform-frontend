        ...
        <div className="flex h-screen bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <header className="bg-linear-to-r from-slate-900 via-slate-800 to-slate-900 border-b border-slate-700 p-6 flex items-center justify-between">
                    ...
                    <button className="flex items-center gap-2 px-5 py-2.5 bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-lg font-medium transition-all duration-200 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30">
                        <Plus size={18} />
                        Create Task
                    </button>
                </header>
